> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [juejin.cn](https://juejin.cn/post/6968713283884974088)
...
function quickSort(arr) {
  ...
  const left = arr.filter((v, i) => v <= p && i !== arr.length - 1);
  const right = arr.filter((v) => v > p);
...
题目描述: ![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4e57b38ac1234cf4b1fd926917ab6ae7~tplv-k3u1fbpfcp-watermark.image)
...
欢迎大家技术交流 内推 摸鱼 求助皆可 - [链接](https://juejin.cn/pin/6968285391736537102)